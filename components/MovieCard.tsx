      ...
      ">
        ...
        <div className="
          ...
          <div className="flex flex-row mt-1 gap-2 items-center"> 
            <p className="text-white text-[15px] lg:text-sm">{data.duration}</p>
          </div>
          <div className="flex flex-row items-center gap-2 mt-1 text-[15px] text-white lg:text-sm">
            <p>{data.genre}</p>
          </div>
        </div>
      </div>
      <p className='text-white text-center mt-1'>{data.title}</p>
    </div>
  )
}
